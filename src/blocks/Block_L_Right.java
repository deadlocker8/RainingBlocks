...
/**
 * Klasse, die den Block in Form eines L repräsentiert
 * (erbt von Block)
 * @author Robert
 *
 */
public class Block_L_Right extends Block
{
	/**
	 * Konstruktor
	 ...
	 */
	public Block_L_Right(String color, int rotation)
	{
		super(color, rotation);		
		center = 14;
		switch(rotation)
		{							
			case 0: 	points = new int[] {center-10, center, center+10, center+11 };
						break;
			case 1:		points = new int[] {center-1, center, center+1, center+9 };
						break;
			case 2:		points = new int[] {center-11, center-10, center, center+10 };
						break;
			case 3:		points = new int[] {center-9, center-1, center, center+1 };
						break;
		}		
	}
	...
	public Board rotateLeft(Board board)
	{
		if(!collidesWithBorder(board))
		{
			...
			{							
				case 0:		rotation = 3; 	
							points = new int[] {center-9, center-1, center, center+1 };								
							break;
				case 1:		rotation = 0;	
							points = new int[] {center-10, center, center+10, center+11 };											
							break;
				case 2:		rotation = 1;
							points = new int[] {center-1, center, center+1, center+9 };											
							break;
				case 3:		rotation = 2;		
							points = new int[] {center-11, center-10, center, center+10 };
							break;
			}		
